...
fun PientTheme(
    ...
    CompositionLocalProvider(
        ...
        // 字体设置全局生效：字体样式 → 全局 FontFamily；字体大小 → 全局缩放
        ...
        MaterialTheme(
            ...
            // ★ M3 1.4.0 的 MaterialTheme 不提供 LocalContentColor，
            // 所有未显式指定 color 的 Text 会回落到默认值 Color.Black —— 暗色模式下黑字
            // 黑底不可见（抽屉"项目："标题、设置列表、技能/插件顶栏、
